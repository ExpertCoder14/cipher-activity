...
// Scramble alphabet based on key
...
// Create the text objects on the headers
...
for (let i = 0; i < 25; ++i) {
	...
	newText.setAttribute('y', Math.floor(i / 5) + 1.5);
	newText.setAttribute('x', Math.floor(i % 5) + 1.5);
